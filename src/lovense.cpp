...
static float current_vibration_speed = 0.0;


// Then update set_vibration_speed to save the value
std::string set_vibration_speed(const std::string& command) {
    ...
    // Save the raw speed integer for retrieval
    current_vibration_speed = speedInt;
...
float get_current_vibration_speed() {
    return current_vibration_speed;
}
